...
namespace Xigen\RandomProduct\Block\Widget;

/**
 * RandomProduct Widget class
 */
class RandomProduct extends \Magento\Catalog\Block\Product\NewProduct implements \Magento\Widget\Block\BlockInterface
{
    /**
        ...
        if ($this->showPager()) {
            if (!$this->_pager) {
                $this->_pager = $this->getLayout()->createBlock(
                    ...
                    'widget.random.product.list.pager'
                );
